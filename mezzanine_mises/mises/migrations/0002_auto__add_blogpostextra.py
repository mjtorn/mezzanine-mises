...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'BlogPostExtra'
        db.create_table('mises_blogpostextra', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('blog_post', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['blog.BlogPost'], unique=True)),
            ('co_author', self.gf('django.db.models.fields.related.ForeignKey')(default=None, related_name='coauthor', null=True, blank=True, to=orm['auth.User'])),
        ))
        db.send_create_signal('mises', ['BlogPostExtra'])


    def backwards(self, orm):
        # Deleting model 'BlogPostExtra'
        db.delete_table('mises_blogpostextra')
    ...
    models = {
        ...
        'mises.blogpostextra': {
            'Meta': {'object_name': 'BlogPostExtra'},
            'blog_post': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['blog.BlogPost']", 'unique': 'True'}),
            'co_author': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'related_name': "'coauthor'", 'null': 'True', 'blank': 'True', 'to': "orm['auth.User']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'})
        },
        'mises.slogan': {
            'Meta': {'object_name': 'Slogan'},
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'slogan': ('django.db.models.fields.CharField', [], {'max_length': '40'})
        },
        'mises.userprofile': {
            ...
            'verification_code': ('django.db.models.fields.CharField', [], {'default': 'None', 'max_length': '40', 'null': 'True', 'blank': 'True'})
        },
        'sites.site': {
