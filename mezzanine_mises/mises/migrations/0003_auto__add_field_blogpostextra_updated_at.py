...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'BlogPostExtra.updated_at'
        db.add_column('mises_blogpostextra', 'updated_at',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now=True, default=datetime.datetime(2012, 10, 20, 0, 0), blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'BlogPostExtra.updated_at'
        db.delete_column('mises_blogpostextra', 'updated_at')
